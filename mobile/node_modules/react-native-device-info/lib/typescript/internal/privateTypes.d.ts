...
import type { DeviceType, LocationProviderInfo, PowerState, AsyncHookResult, AvailableCapacityType } from 'react-native-device-info/lib/typescript/internal/types';
...
export declare type Getter<T> = (...args: any[]) => T;
